...
- **Multi-week reports** with standard cost and nutrition charts, plus AI-driven additions (new columns, chart-shape changes) that persist as part of session state.
